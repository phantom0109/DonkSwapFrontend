                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      ...
                      case 'UniswapV2Router: EXCESSIVE_INPUT_AMOUNT':
                        ...
                        break
                      default:
                        errorMessage = `The transaction cannot succeed due to error: ${callError.reason}. This is probably an issue with one of the tokens you are swapping, try increasing your slippage.`
                    }
