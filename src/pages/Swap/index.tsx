...
const Swap = () => {
  ...
  return (
    <>
      ...
      <h3 id="dex-title-under-logo" style={{ fontSize: '30px' }}> <center> Donkey King Entertainment Group</h3>
      <div className="relative h-full w-swap" id="donkLogo">
        <img
      ...
      <AppBody>
        <Wrapper id="swap-page">
          ...
          />
          <PageHeader
            title={TranslateString(8, 'DonkSwap')}
            description={TranslateString(1192, 'Fastest way to swap tokens')}
          />
          <CardBody>
            <AutoColumn gap="md">
              <CurrencyInputPanel
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center' }}>
                  <Text className="text-cream" mb="4px">
